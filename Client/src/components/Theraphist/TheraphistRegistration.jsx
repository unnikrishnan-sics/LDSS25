    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                `${import.meta.env.VITE_SERVER_URL}/ldss/theraphist/registration`,
                formData,
                {
                    headers: {
            ...
            } else if (result.message === "theraphist already registered with this email") {
                toast.error("You have already registered with this email");
            } else if (result.message === "theraphist created successfully") {
                // Reset form
                setData({
                    name: "",
                    email: "",
