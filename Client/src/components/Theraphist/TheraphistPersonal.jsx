        ...
        <>
            ...
            <Container sx={{ position: "relative" }} maxWidth="x-lg">
                ...
                <Box display={'flex'} alignItems={'center'} justifyContent={'center'} flexDirection={'column'}>
                    ...
                    <Box sx={{ display: "flex", justifyContent: 'center', alignItems: "start", gap: "30px", height: "293px", flexDirection: "column", marginTop: '80px' }}>
                    ...
                    <Box display={'flex'} alignItems={'center'} justifyContent={'center'} flexDirection={'column'} sx={{ width: '253px', gap: '10px', mb: "60px" }}>
                        <Button onClick={handleSubmit} variant='contained' color='secondary' sx={{ borderRadius: "25px", marginTop: "100px", height: "40px", width: '150px', padding: '10px 35px' }}>Confirm</Button>
...
export default TheraphistPersonal
